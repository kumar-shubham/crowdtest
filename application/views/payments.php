...
<head>
    ...
    <title>SCRUM | Payments Received</title>
                ...
                <div class="ibox float-e-margins">
                   ...
                   <?php foreach($results as $records){?>
                    <tr >
						...
						<button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="bottom" title="Delete" onclick="deleteUser('<?php echo $records->invoice_id ;?>');" aria-label="right Align">

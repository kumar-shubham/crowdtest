...
<h2>					
<a class="btn btn-primary " href="<?php echo base_url();?>Menus/client_details" >Add a new client</a></h2>
                   ...
                   <?php foreach($results as $records){?>
                    <tr >
                        ...
                        <td> 
                         ...
                         <a href="<?php echo base_url();?>Menus/view_client_by_id/<?php echo $records->client_id ;?>">
						...
						<button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="bottom" title="Delete" onclick="deleteClient('<?php echo $records->client_id ;?>');" aria-label="right Align">

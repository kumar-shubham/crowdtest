 ...
 * Define controllers with data used in SCRUM theme
 *
 *
...
function notifyCtrl($scope, notify) {
    ...
    $scope.SCRUMTemplate = 'views/common/notify.html';
    $scope.SCRUMDemo1 = function(){
        notify({ message: 'Info - This is a SCRUM info notification', classes: 'alert-info', templateUrl: $scope.SCRUMTemplate});
    }
    $scope.SCRUMDemo2 = function(){
        notify({ message: 'Success - This is a SCRUM success notification', classes: 'alert-success', templateUrl: $scope.SCRUMTemplate});
    }
    $scope.SCRUMDemo3 = function(){
        notify({ message: 'Warning - This is a SCRUM warning notification', classes: 'alert-warning', templateUrl: $scope.SCRUMTemplate});
    }
    $scope.SCRUMDemo4 = function(){
        notify({ message: 'Danger - This is a SCRUM danger notification', classes: 'alert-danger', templateUrl: $scope.SCRUMTemplate});
    }
}
